...
import { Plus, UserMinus, UserPlus, Wrench } from 'lucide-react';
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-text-secondary">
            Line items on this order. Add/edit/delete services are deferred until
            CreateOrderServiceRequest is documented in api-contract.md §10.
          </p>
        </div>
        <Button variant="secondary" disabled leftIcon={<Plus className="size-4" />} title="Deferred">
          Add service (deferred)
        </Button>
      </div>
