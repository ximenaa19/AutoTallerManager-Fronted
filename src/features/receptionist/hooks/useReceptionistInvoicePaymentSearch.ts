...
import type { InvoiceSearchResultDto } from '@/features/receptionist/types/receptionistPayments.types';

export interface UseReceptionistInvoicePaymentSearchParams {
  minTermLength?: number;
}

export interface UseReceptionistInvoicePaymentSearchResult {
  term: string;
...
export function useReceptionistInvoicePaymentSearch(
  params: UseReceptionistInvoicePaymentSearchParams = {},
): UseReceptionistInvoicePaymentSearchResult {
