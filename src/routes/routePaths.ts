export const ROUTES = {
  ...
  ADMIN_CLIENT_DETAIL: '/admin/clients/:personId',
  ...
  ADMIN_INVOICE_DETAIL: '/admin/invoices/:invoiceId',
...
export function adminClientDetailPath(personId: number): string {
  return `/admin/clients/${personId}`;
}
